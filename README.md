...
> Top Left - This is an unrotated ordination of New York fossils from ~380 million years ago. Each point represents a different sample of fossils taken from various points in New York. The closer points are together, the more similar the faunas of those fossils are. Conversely, samples that are far apart in the plot share few (or no) species in common. However, because there are >100 species and >400 samples, we cannot know what is causing these species to be distributed differently without more contextual information.

> Top Right - This is a map of New York State Counties. Western counties with reef-like sediments are colored blue. Central counties with deep water and mixed-sediment type conditions are colored orange. Eastern counties with sandy beach-like sediments are colored red. If we go back and color the first figure (Top Left) using this schema, we see that the bottom-left of the plot is dominated by samples from western, reef environments and top-left samples are dominated by eastern, beach environment samples. 

> Bottom Left - This is a variation of the first figure illustrating the relative similarity of different New York fossil species. Each point represents a species, and the closer points are to each other then the more samples they occur in together. In addition, I applied an affine rotation to the points, so that the x-axis runs parallel to the west-east (blue-red) gradient that ran diagonally across the original ordination (Top Left)

> Bottom Right - Once this correction is applied, the biological clustering of taxa closely follows older qualitative descriptions of where different characteristic taxa should be distributed in relation to water depth and turbidity. The turbidity axis (reef-sandy; west-east) is expressed along DCA Axis 1. Lower DCA 1 scores are dominated by tropical reef taxa, particularly large corals and brachiopods. Sandy-tolerant faunas dominate higher DCA 1 scores, particularly large clams and snails characteristic of ancient beaches. The water depth gradient is expressed along DCA Axis 2. Shallow-water faunas from reefs and beaches plot towards the top, while deeper-water diminutive brachiopods and pelagic taxa (deep-water swimmers; purple) populate the bottom. This means that we have quantitatively expressed, using a completely agnostic method, the commonly inferred environmental determinants of species distribution in the ancient oceans of New York.
